  ...
  return {
    ...
    entities: {
      state:{
       integration: "event",
       entity_conf: {
          value_template: "{ \"event_type\": \"{{ value_json.object.button_event.status }}\" }",
          event_types: ["short press", "double press", "long press"],
          device_class: "button"
        }
      },
      battery:{
          entity_conf: {
            value_template: "{{ value_json.object.battery | float }}",
